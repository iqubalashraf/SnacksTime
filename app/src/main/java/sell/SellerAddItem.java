...
public class SellerAddItem extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.seller_add_item);
        //Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar);
        //setSupportActionBar(toolbar);
    }
    public void addItemToServer(View view){
    ...
    public class AddItemToServer extends AsyncTask<String, Void, Boolean> {
        ...
        protected void onPostExecute(Boolean result) {
            ...
            if(serverResponse.contains("0")){
                Toast.makeText(getApplicationContext(),"Maximum limit has reached",Toast.LENGTH_SHORT).show();
    ...
    public void onBackPressed(){
        Intent sellerHome = new Intent(SellerAddItem.this,SellerHome.class);

...
public class RemoveItem extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.seller_remove_item);
        //Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar);
        //setSupportActionBar(toolbar);
    }
    public void removeItemFromServer(View view){
        itemName = (EditText)findViewById(R.id.itemNameRemove);
    ...
    public class AddItemToServer extends AsyncTask<String, Void, Boolean> {
        ...
        protected void onPostExecute(Boolean result) {
            ...
            if(serverResponse.contains("0")){
                Toast.makeText(getApplicationContext(), "Item dose not Exist ", Toast.LENGTH_SHORT).show();
    ...
    public void onBackPressed(){
        Intent sellerHome = new Intent(RemoveItem.this,SellerHome.class);
